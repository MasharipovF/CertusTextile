...
/**
 * Created by Farrukh on 22.04.2016.
 */
public class SlideShowAdapter extends RecyclerView.Adapter<SlideShowAdapter.GridHolder>
        implements DraggableItemAdapter<SlideShowAdapter.GridHolder> {
    ...
    public SlideShowAdapter(List<StickerData> list, Context ctx, CoordinatorLayout layout, int vis) {
        context = ctx;
        stickerList = list;
        oldStickerList = list;
